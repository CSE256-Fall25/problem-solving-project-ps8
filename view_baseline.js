...
obj_name_div = $('<div id="permdialog_objname" class="section">File Name: <span id="permdialog_objname_namespan" style="font-weight: bold;"></span> </div>')
...
file_permission_users = define_single_select_list('permdialog_file_user_list', function (selected_user, e, ui) {
    ...
    if (selected_user && selected_user.length > 0) {
        grouped_permissions.removeClass("locked")
    } else {
...
perm_dialog.append($('<div id="permissions_user_title" style="font-style: italic; margin-top: 16px">Select a user to see permissions:</div>'))
...
file_permission_users.on('click', '.file-user', function () {
